...
// Page Configuration
$sayfa = "Guven";  // Page name
$baslik = $this->lang->header("Guven"); // Page title from translation file
                            ...
                            <div class="col-lg-4 sidemenu119">
                                <div class="lister_sidebar">
                                    <div class="sub_menu wbx_1">
                                        ...
                                        <ul>
                                            <li>
                                                <a href="<?= $this->BaseURL('kristal', $lang, 1) ?>">Kristal Mensucat</a>
                                            </li>
                                            <li>
                                                <a class="active" href="<?= $this->BaseURL('guven', $lang, 1) ?>">Güven Boya</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!--
                            ...
                            <div class="col-lg-8">
                                <div class="corporate content-detail">
                                    <div class="partner_logo">
                                        ...
                                        <img src="<?= $assetURL ?>images/a2.jpg" alt="">
                                    </div>
